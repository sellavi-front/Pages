...
let scrolled = () => {
  ...
  if(document.querySelector("header").classList.contains("scrolled")) {
    ...
    document.querySelector("#home > div.wrapper.wrapper-closed > header > div.header-wrapper > div > div.logo.navbar__block > div > button").classList.remove("scrolled_item")
    ...
    document.querySelector("#home > div.wrapper.wrapper-closed > header > div.header-wrapper > div > div.logo.navbar__block > a:nth-child(3)").classList.remove("scrolled_item")
    ...
    document.querySelector("#home > div.wrapper.wrapper-closed > header > div.header-wrapper > div > div.logo.navbar__block > a:nth-child(4)").classList.remove("scrolled_item")
    document.querySelector("#search > button > i").classList.add("no_scrolled_item")
    document.querySelector("#search > button > i").classList.remove("scrolled_item")
    document.querySelector("#cart").classList.add("no_scrolled_item")
    document.querySelector("#cart").classList.remove("scrolled_item")
    ...
    document.querySelector("#home > div.wrapper.wrapper-closed > header > div.header-wrapper > div > div.logo.navbar__block > div > div").classList.remove("scrolled_dropdown")
    ...
    document.querySelector("#home > div.wrapper.wrapper-closed > header > div.header-wrapper > div > div.logo.navbar__block > div > div > a:nth-child(1)").classList.remove("scrolled_dropdown_item")
    ...
    document.querySelector("#home > div.wrapper.wrapper-closed > header > div.header-wrapper > div > div.logo.navbar__block > div > div > a:nth-child(2)").classList.remove("scrolled_dropdown_item")
    ...
    document.querySelector("#home > div.wrapper.wrapper-closed > header > div.header-wrapper > div > div.logo.navbar__block > div > div > a:nth-child(3)").classList.remove("scrolled_dropdown_item")
    document.querySelector("#home > div.wrapper.wrapper-closed > header > div.header-wrapper > div > div.logo.navbar__block > div > div").classList.add("no_scrolled_dropdown")
    document.querySelector("#home > div.wrapper.wrapper-closed > header > div.header-wrapper > div > div.logo.navbar__block > div > div").classList.remove("scrolled_dropdown")
  }
}
