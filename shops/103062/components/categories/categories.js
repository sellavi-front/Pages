...
let fixHomeCategories = () => {
  if(pages.home) {
    document.querySelector("#home > div > div.content-area > section.page-section.homefeatured_category > div > div > div:nth-child(1) > div > div > a > picture > img").setAttribute("src", "https://res.cloudinary.com/sellavi-estarodubov/image/upload/v1611056092/sellavi/103062/baby-wooden-toy-teethers-pastel-colors-pink_1_e3v1rc.jpg")
    document.querySelector("#home > div > div.content-area > section.page-section.homefeatured_category > div > div > div:nth-child(2) > div > div > a > picture > img").setAttribute("src", "https://res.cloudinary.com/sellavi-estarodubov/image/upload/v1611056092/sellavi/103062/baby-romper-soother-wooden-toys-blue_1_nipvs8.jpg")
