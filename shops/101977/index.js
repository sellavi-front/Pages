...
document.querySelector('#home > div > header > div.header-wrapper > div.container > nav').insertAdjacentHTML('beforebegin', '<span><a href="/">AL`DOMA</a></span>');
...
// if (location.pathname !== '/') {
  document.querySelector('.content-area').insertAdjacentHTML('beforeend', '<div class="map-flex"><div class="container"><div class="our-contacts"><div>Контакты</div><div class="adress"><div>Адрес: </div><div>г.Волгоград, ул.Бурейская, д.8</div></div><div class="phone"><div>Телефон: </div><div>8-800-707-24-24</div></div><div class="emails"><div>E-mail: </div><div><a style="color: #377736;" href="mailto:sgmaier@yandex.ru">sgmaier@yandex.ru</a></div></div></div><iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3A7efb2b1c48455fd2e1c95a8256260ab3e86490a95490800b620cd291dff510af&amp;source=constructor" width="600" height="400" frameborder="0"></iframe></div></div>');
// }
...
if (screen.width < 480) {
  ...
  document.querySelector('.mobile-navigation-wrapper.d-lg-none.d-xl-none.sticky').insertAdjacentHTML('beforeend', '<div class="dropdown cart_drop_down"><a tabindex="0" href="#" id="cart" data-toggle="dropdown" data-display="static" title="Перейти в корзину" aria-haspopup="true" aria-expanded="false" role="link"><i class="far fa-shopping-cart"></i><span class="cart-norm-qty d-none d-lg-inline-block">Товаров 0 (0.00 ₽)</span><span class="cart-qty-circle d-block d-lg-none">0</span></a><div class="dropdown-menu dropdown-menu-right"><div class="cart-items"><div class="cart-items-inner overflow-hidden"><div class="col-12"><div class="cart-content"><div class="row cart-header"><div class="col-12"><p>Ваша корзина, 0 товар/ы</p></div></div><div class="row empty_cart"><div class="col-12"><p>Ваша корзина пуста</p></div></div></div></div></div></div></div></div>');
}
