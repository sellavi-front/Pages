...
if(pages.home) {
  ...
  if(window.screen.width >= 575) {
    ...
    document.querySelector(".custom_banner").insertAdjacentHTML("afterbegin", `<div class="container"><img src="https://cdn.sellavi.com/image/upload/v1608731970/ru/clients/101263/a6badf471eb3c898e4899515a3c0fda8d28aa081.jpg" alt="banner"/></div>`)
  } else {
    /*const imgCat = document.querySelectorAll(".content-area>.main-slider>#banner0>.owl-wrapper-outer>.owl-wrapper>.owl-item>.item>.img-bg>.img-fluid")
    imgCat.forEach(cat => {
      const src = cat.getAttribute('src');
    ...
    document.querySelector(".custom_banner").insertAdjacentHTML("afterbegin", `<div class="container"><img src="https://cdn.sellavi.com/image/upload/q_auto:420/v1608731984/ru/clients/101263/5ab4a1a11b389c4dc868d48c69c86948e1ed0050.jpg" alt="banner"/></div>`)
  }
