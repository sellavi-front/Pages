...
if (location.href.includes("checkout")) {
  $('.form_checkout').ready(function () {
    ...
    document.querySelector(".checkbox>label").insertAdjacentHTML("afterend", '<div class="read_doc"><small><a href="/term-of-use/" style="text-decoration: none !important; "><b style="font-weight: bold !important;">Ознакомиться с публичной офертой</b></a></small></div>')
  })
}
