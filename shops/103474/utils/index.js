...
jQuery(() => {
  if (document.querySelector('.wrapper')) {
    const target = document.querySelector("header > div.header-wrapper > div > div.header_widgets > div.header-cart.sticky > div.cart-wrapper > div.dropdown.cart_drop_down .cart-content");
