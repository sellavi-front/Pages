...
jQuery(function () {
  if (document.querySelector('.wrapper')) {
    ...
    // }
    const target = document.querySelector("#home > div > header > div.header-wrapper > div > div.header_widgets > div.header-cart.sticky > div.cart-wrapper > div.dropdown.cart_drop_down .dropdown-menu .cart-content .products_row");
    console.log(target);
    const config = {
      childList: true,
    };
