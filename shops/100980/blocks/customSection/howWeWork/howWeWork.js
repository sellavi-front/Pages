  ...
  <div class="steps__how_container">
      ...
      <div class="steps__how_item">
          <div class="step__item">
              ...
              <h6>ЗАЯВКА</h6>
              <p class="howDesc">Вы звоните нам или оставляете заявку через форму обратной связи и с Вами связывается наш менеджер</p>
          </div>
      </div>
      ...
      <div class="steps__how_item">
          <div class="step__item">
              ...
              <h6>ВЫЕЗД</h6>
              <p class="howDesc">Менеджер уточняет детали по проекту, производим бесплатно осмотр и замер помещения</p>
          </div>
      </div>
      ...
      <div class="steps__how_item">
          <div class="step__item">
              ...
              <h6>ДОГОВОР</h6>
              <p class="howDesc">Делаем предварительный план расстановки оборудования и подписываем договор на создание проектной документации и визуализации помещения. Срок выполнения: 2 недели.</p>
          </div>
      </div>
      ...
      <div class="steps__how_item">
          <div class="step__item">
              ...
              <h6>МОНТАЖ</h6>
              <p class="howDesc">Выполняем строительно-монтажные работы в помещении, выполняем оснащение оборудованием. Срок выполнения: 2-4 недели.</p>
          </div>
      </div>
      ...
      <div class="steps__how_item">
          <div class="step__item">
              ...
              <h6>ЗАПУСК</h6>
              <p class="howDesc">Производим тестовый запуск всех систем и оборудования. Устанавливаем вывеску и размещаем менюборды. Срок выполнения 3 дня.</p>
          </div>
      </div>
      ...
      <div class="steps__how_item">
          <div class="step__item">
              ...
              <h6>ОКОНЧАНИЕ</h6>
              <p class="howDesc">Подписываем с вами документы по завершению работ и вводу оборудования в эксплуатацию. Срок выполнения 2 дня.</p>
          </div>
      </div>
      ...
      <div class="steps__how_item">
          <div class="step__item">
              ...
              <h6>ФОТОСЕССИЯ</h6>
              <p class="howDesc">Выполняем официальный запуск. Делаем фотосессию и видеосъёмку.</p>
          </div>
      </div>
      ...
      <div class="steps__how_item">
          <div class="step__item">
              ...
              <h6>ОТЗЫВ</h6>
              <p class="howDesc">Благодарим вас за совместную работу и просим написать для нас отзыв на фирменном бланке компании.</p>
          </div>
      </div>
