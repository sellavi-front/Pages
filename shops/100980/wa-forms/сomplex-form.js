...
let sendComplexForm = () => {
  ...
  let sender = new WhatsAppWidget(complexFormBtn, "79324247663", "Бесплатный расчет стоимости коммерческого предложения.", arrHome, "Расскажите подробнее, пожалуйста.")
  sender.call()
}
