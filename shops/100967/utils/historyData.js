const historyData = [
  {
    date: '1951г.',
    line: 'https://res.cloudinary.com/gz-company/image/upload/v1606229725/Miru/assets/historyline/Group_89_aqk1ml.png',
  ...
  },
  {
    ...
    text: 'Ознаменовал появление на рынке средств контактной коррекции мягких японских контактных линз – Menicon Soft.',
  },
  {
    date: '1979г.',
    line: 'https://res.cloudinary.com/gz-company/image/upload/v1606229725/Miru/assets/historyline/Group_94_toqfdj.png',
    img: 'https://res.cloudinary.com/gz-company/image/upload/v1606230253/Miru/assets/miru_1month_astigmatism_sxx62o.png',
    title: 'Созданы первые «дышащие» жёсткие контактные линзы',
