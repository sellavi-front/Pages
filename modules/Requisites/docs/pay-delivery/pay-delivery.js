...
<div class="d-flex content-delivery">
  ...
  <section class="delivery__content">
    ...
    <p class="delivery__content-label">
      ...
      предоплаты в режиме онлайн). Время работы нашего сотрудника: ${obj.timeWork} При получении товара обязательно проверьте комплектацию товара и наличие чека.
    </p>
  </section>
</div>
<div class="d-flex content-delivery">
  ...
  <section class="delivery__content">
    ...
    <p class="delivery__content-label">
      ...
      Повторная отправка на твой адрес производится за ваш счёт, а возврат денег – за вычетом
