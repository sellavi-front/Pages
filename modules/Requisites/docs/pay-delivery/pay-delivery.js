...
<div class="d-flex content-delivery">
  ...
  <section class="delivery__content">
    ...
    <p class="delivery__content-label">
      Только в г. Москве по выбору покупателя возможно получение заказа у сотрудника нашей компании
      ...
      предоплаты в режиме онлайн). Время работы нашего сотрудника: понедельник – пятница ${obj.timeWork} При получении товара обязательно проверь комплектацию товара и наличие чека.
    </p>
  </section>
</div>
<div class="d-flex content-delivery">
